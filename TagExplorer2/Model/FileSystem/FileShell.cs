...
namespace TagExplorer2.Utils
{
    ...
    public class FileShell
    {
        ...
        public static void OpenExplorer(string dir)
        {
            ...
            {
                Logger.D("OpenTagDir {0} {1}", dir, dir);
                Process.Start(dir);
            }
        }
        ...
        {
            return file.EndsWith(StaticCfg.Ins.DefaultNote);
        }
        /// <summary>
        /// 打开文件
        /// </summary>
        ...
        private static void EnsureDirExist(string f)
        {
            DirectoryInfo dir = new FileInfo(f).Directory;
            EnsureCreateDir(dir);
        }
        private static void EnsureCreateDir(DirectoryInfo dir)
        {
